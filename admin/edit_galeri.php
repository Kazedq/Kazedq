...
<head>
  ...
  <title>Admin-Edit-Galery| Pemesanan Hotel</title>
              ...
              <div class="card-body">
                <form method="post" action="update_galeri.php" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <input name="id_galeri" value="<?php echo $data['id_galeri']; ?>" hidden>
                    <input type="text" class="form-control" value="<?php echo $data['ket_fasilitas']; ?>" name="ket_fasilitas" placeholder="Ket_fasilitas">
                  </div>
                  <div class="form-group">
                    <label>Foto</label>
